...
const Footer = () => {
  return (
    <footer className="w-11/12 xl:w-3/4 mx-auto pt-10 pb-5 px-2 border-b-8 border-slate-600">
      <div className="grid grid-cols-1 xl:grid-cols-3">
        ...
        <div className="col-span-2 hidden xl:grid grid-cols-3 gap-5">
          <div>
            <h1 className="uppercase text-xl font-semibold text-slate-600 my-3">information</h1>

            <Link
              to="/about"
              className="font-medium hover:text-slate-600 duration-300 ease-in-out block py-1 border-l-4 border-transparent hover:border-slate-400 hover:pl-2 -ml-1"
            >
              About Us
            </Link>
            <Link
          ...
          <div>
            <h1 className="uppercase text-xl font-semibold text-slate-600 my-3">account</h1>
          ...
          <div>
            <h1 className="uppercase text-xl font-semibold text-slate-600 my-3">Quick Shop</h1>
